    ...
    <section className="w-full">
      ...
      <div className="w-full text-center px-20 py-15">
        ...
        <div className="w-full flex flex-wrap justify-center items-start">
          {dataLayanan.map(({judul, link, gambar, bintang, keterangan, online}, index) => (
            <a href={`/layanan/${link}`} key={index} className="w-3/12 p-5 cursor-pointer hover:scale-105 transition-all duration-300">
              <img
                src={`./layanan/${gambar}`}
                alt={judul}
      ...
      <div className="w-full px-20 py-15">
        <div className="w-full border-b border-gray-300">
          <h1 className="w-full font-bold px-3 py-5 text-xl cursor-pointer hover:text-orange-600 transition-all duration-300"><i className="bi-caret-right-fill me-3"></i>Apa itu percetakan?</h1>
          <div className="mt-5 w-full text-gray-600 cursor-default hidden">
        ...
        <div className="w-full border-b border-gray-300">
          <h1 className="w-full font-bold px-3 py-5 text-xl cursor-pointer hover:text-orange-600 transition-all duration-300"><i className="bi-caret-right-fill me-3"></i>Apa itu percetakan online?</h1>
          <div className="mt-5 w-full text-gray-600 cursor-default hidden">
        ...
        <div className="w-full border-b border-gray-300">
          <h1 className="w-full font-bold px-3 py-5 text-xl cursor-pointer hover:text-orange-600 transition-all duration-300"><i className="bi-caret-right-fill me-3"></i>Apa saja produk & layanan yang ada di Hanami Printing?</h1>
          <div className="mt-5 w-full text-gray-600 cursor-default hidden">
        ...
        <div className="w-full border-b border-gray-300">
          <h1 className="w-full font-bold px-3 py-5 text-xl cursor-pointer hover:text-orange-600 transition-all duration-300"><i className="bi-caret-right-fill me-3"></i>Bagaimana cara memesan?</h1>
          <div className="mt-5 w-full text-gray-600 cursor-default hidden">
            <div className="flex justify-center items-start gap-5">
        ...
        <div className="w-full border-b border-gray-300">
          <h1 className="w-full font-bold px-3 py-5 text-xl cursor-pointer hover:text-orange-600 transition-all duration-300"><i className="bi-caret-right-fill me-3"></i>Berapa lama waktu yang dibutuhkan untuk proses percetakan?</h1>
          <div className="mt-5 w-full text-gray-600 cursor-default hidden">
        ...
        <div className="w-full border-b border-gray-300">
          <h1 className="w-full font-bold px-3 py-5 text-xl cursor-pointer hover:text-orange-600 transition-all duration-300"><i className="bi-caret-right-fill me-3"></i>Bagaimana cara mengirim file desain cetak?</h1>
          <div className="mt-5 w-full text-gray-600 cursor-default hidden">
            ...
            <ul className="list-decimal w-full ms-5">
              ...
              <ul className="list-disc ms-5 mb-3">
                ...
                <li className="text-justify"><span className="font-bold">Mode Warna</span> - Gunakan mode warna CMYK (Cyan, Magenta, Yellow, Black) karena ini adalah standar untuk percetakan. Mode warna RGB digunakan untuk layar digital dan tidak cocok untuk cetakan.</li>
        ...
        <div className="w-full border-b border-gray-300">
          <h1 className="w-full font-bold px-3 py-5 text-xl cursor-pointer hover:text-orange-600 transition-all duration-300"><i className="bi-caret-right-fill me-3"></i>Apakah ada minimum jumlah order?</h1>
          <div className="mt-5 w-full text-gray-600 cursor-default hidden">
        ...
        <div className="w-full">
          <h1 className="w-full font-bold px-3 py-5 text-xl cursor-pointer hover:text-orange-600 transition-all duration-300"><i className="bi-caret-right-fill me-3"></i>Bagaimana cara memastikan warna cetakan sesuai dengan desain?</h1>
          <div className="mt-5 w-full text-gray-600 cursor-default hidden">
