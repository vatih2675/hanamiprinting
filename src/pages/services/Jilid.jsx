...
export default function Jilid({dataApp}) {
    return (
            ...
            <div className="w-full p-20 flex justify-center items-start cursor-default">
                ...
                <div className="w-full ps-10">
                    <div className="flex justify-start items-center w-full gap-2 mb-10 text-3xl">
                        ...
                        <span>/</span>
                        <h1 className="text-3xl text-orange-500 font-bold">Jilid</h1>
                    </div>
                    <div className="w-full bg-white rounded-xl p-5 shadow-black/10 shadow-lg">
                        <div className="w-full flex justify-between items-center mb-5">
                            <h3 className="text-orange-500 font-bold text-xl">Jilid</h3>
                        ...
                        <div className="relative flex justify-center items-start gap-5">
                            <img src="../layanan/jilid.png" alt="" className="w-4/12 rounded-xl shadow-black/10 shadow-lg" />
                            <div className="w-full">
                                <p className="text-justify">Jilid dokumen dengan plastik transparan dan kertas bufalo dengan lakban hitam.</p>
                            </div>
